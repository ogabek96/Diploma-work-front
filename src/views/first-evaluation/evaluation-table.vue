<template>
  <div class="patients-table">
    ...
    <el-table v-loading="loading" :data="tableData" border fit highlight-current-row style="width: 100%;">
      ...
      <el-table-column :label="'Медицинское учреждение, установившее диагноз ЗН:'" prop="patientId" sortable="custom" align="center">
      ...
      <el-table-column :label="'Действия'" prop="bloodGroup" sortable="custom" align="center" class-name="small-padding fixed-width" width="400px">
        <template slot-scope="scope">
          <router-link :to="'evaluation/' + scope.row.id + '/edit'">
            <el-button type="primary" size="small">Редактировать</el-button>
          </router-link>
          <router-link :to="'evaluation/' + scope.row.id + '/detail'">
...
<script>
import { getAll, deleteById } from '@/api/first-evaluation'
export default {
