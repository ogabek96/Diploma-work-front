export default {
  ...
  patients: {
    ...
    bloodGroup: {
      label: 'Группа крови по системе АВО',
      '0': 'нет данных',
      '1': '0(I)',
      '2': 'А(II)',
      '3': 'В(III)',
    ...
    patientStatus: {
      label: 'Последний известный статус больного',
      '0': 'нет данных',
      '1': 'жив',
      '2': 'выбыл из-под наблюдения по причине эмиграции',
      '3': 'выбыл из-под наблюдения по причине снятия диагноза'
    },
    patientType: {
      label: 'Тип больного',
      '1': 'Первичный больной',
